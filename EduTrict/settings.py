"""
Django settings for EduTrict project.
...
SECRET_KEY = 'django-insecure-$vlv@)%oxmbzr$@^j(=w5&jqfw@-v0$iw&k^32a9grd_63&sl^'
...
WSGI_APPLICATION = 'EduTrict.wsgi.application'
